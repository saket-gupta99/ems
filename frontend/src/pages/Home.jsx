          ...
          <div className="flex flex-col md:flex-row items-center gap-8">
            <div className="w-full md:w-1/2">
              ...
              <p className="text-gray-600 mb-6">
                Established in 2017 in Mumbai, Maharashtra, we "S I Infratech
                LLP" are a trusted name in the construction industry. We
                specialize in waterproofing, construction, and maintenance
                services, delivering excellence with every project.
              </p>
            </div>
